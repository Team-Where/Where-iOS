...
enum CoreEvent {
    ...
    case inAppMeetingInvited(title: String, imageURL: String?, inviterName: String, scheduledTime: String?, scheduledDate: String?, meetingID: UInt64)
    
    // MARK: - Common
    case applicationDidLaunch
    case fcmTokenUpdated(fcmToken: String)
}
