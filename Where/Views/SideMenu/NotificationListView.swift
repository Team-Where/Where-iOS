...
struct NotificationListView: View {
    @State private var notifications: [Notification] = [
        .init(id: 0, title: "친구 추가", content: "냠냠쩝쩝님이 또구몬님을 친구로 추가하셨어요.", date: .now),
        .init(id: 1, title: "오늘의 모임", content: "오늘 또구몬님의 모임이 있어요!", date: .now),
        .init(id: 2, title: "모임 초대", content: "또구몬님이 냠냠쩝쩝님의 모임에 초대되었어요.", date: .now),
        .init(id: 3, title: "공지", content: "[이벤트] 신규가입 이벤트 당첨자가 발표되었어요.", date: .now),
        .init(id: 4, title: "답변 완료", content: "1:1 답변 등록이 완료되었습니다.", date: .now),
        .init(id: 5, title: "모임 안내문", content: "모임을 추가하는 방법을 FAQ에서 알아보세요!", date: .now)
    ]
